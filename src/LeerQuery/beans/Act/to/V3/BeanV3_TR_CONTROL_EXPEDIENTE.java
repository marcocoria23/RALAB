 ...
 */
public class BeanV3_TR_CONTROL_EXPEDIENTE extends Bean implements SQLData {
    ...
    private String LATITUD_ORG;
    private String LONGITUD_ORG;
    ...
    public String GetLATITUD_ORG() {
        return LATITUD_ORG;
    }

    public void SetLATITUD_ORG(String LATITUD_ORG) {
        this.LATITUD_ORG = LATITUD_ORG;
    }

    public String GetLONGITUD_ORG() {
        return LONGITUD_ORG;
    }

    public void SetLONGITUD_ORG(String LONGITUD_ORG) {
        this.LONGITUD_ORG = LONGITUD_ORG;
    }
