...
public ArrayList ActorNI(String Con1, String Con2){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(Actor,'99','No identificado') Actor,PERIODO FROM "+Con1+"TR_PART_ACT_COLECTIVO"+Con2+"\n" +
...
public ArrayList Actor_Sindicato(String Con1, String Con2){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(ACTOR,'3','Sindicato') ACTOR,PERIODO FROM "+Con1+"TR_PART_ACT_COLECTIVO"+Con2+"\n" +
...
public ArrayList Actor_Patron(String Con1, String Con2){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(ACTOR,'2','Patron') ACTOR,PERIODO FROM "+Con1+"TR_PART_ACT_COLECTIVO"+Con2+"\n" +
...
public ArrayList Persona_Fisica(String Con1, String Con2){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(TIPO,'1','Persona_fisica') TIPO,PERIODO FROM "+Con1+"TR_PART_ACT_COLECTIVO"+Con2+"\n" +
