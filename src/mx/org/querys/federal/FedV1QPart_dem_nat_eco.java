 ...
 */
public class FedV1QPart_dem_nat_eco {
...
"or CANTIDAD_DEMANDADOS>0) where expediente_clave not in (select expediente_clave from TR_FED_V1_part_DEM_COLECT_ECONOMJL where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
resul=conexion.consultar(sql);
    System.out.println(sql);
      ...
      conexion.close();
            ...
            Logger.getLogger(FedV1QPart_dem_nat_eco.class.getName()).log(Level.SEVERE, null, ex);
        }
    return Array;    
}
...
"FROM TR_FED_V1_part_DEM_COLECT_ECONOMJL\n" +
