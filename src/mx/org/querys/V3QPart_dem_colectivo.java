...
" CANTIDAD_DEMANDADOS>0) where expediente_clave not in (select expediente_clave from V3_tr_part_DEM_colectivojl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
