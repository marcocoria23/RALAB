...
public static String impErro = "",RutaT="";
    ...
    public void Read_Control_Expediente() throws FileNotFoundException, IOException {
         ...
         try {          
            ...
            if (bytesRead >= 3 && bytes[0] == (byte) 0xEF && bytes[1] == (byte) 0xBB && bytes[2] == (byte) 0xBF) {
                System.out.println("Archivo en UTF-8");
                 ...
                 IN_CONTROL_EXPEDIENTE(rutaCarpetaArchivos,Insert.Periodo);
            }else{
                 System.out.println("6.....");
                conUTF8.Convertir_utf8_EBaseDatos(rutaCarpetaArchivos);
                 IN_CONTROL_EXPEDIENTE(conUTF8.rutaNuevoArchivo,Insert.Periodo);
   ...
   public void IN_CONTROL_EXPEDIENTE(String Ruta,String Periodo) throws Exception {
                ...
                try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(rutaArchivoCSV), StandardCharsets.UTF_8));
                    ...
                    if (numeroColumnas == 33) {
                        ...
                        for (CSVRecord record : csvParser) {
                            ...
                            c.SetCIRCUNS_ORG_JUR(record.get(21).toUpperCase());
                            c.SetOTRO_ESP_CIRCUNS(record.get(22).toUpperCase());
                            c.SetJURISDICCION(record.get(23).toUpperCase());
                 ...
                 if (TotalRegistros>0){
                        ...
                        sd = StructDescriptor.createDescriptor("OBJ_CONTROL_EXPEDIENTE", con);
                        ...
                        descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_CONTROL_EXPEDIENTE", con);
    ...
    JOptionPane.showMessageDialog(
        null,
            "Tabla: V3_TMP_CONTROL_EXPEDIENTEJL\n" +
