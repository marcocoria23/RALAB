 ...
 */
public class V2QPart_colectivoNE {
...
"from(\n" +
"select * from(\n" +
"select * from v2_tr_colectivojl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
"or CANTIDAD_DEMANDADOS>0) where expediente_clave not in (select expediente_clave from v2_tr_part_colectivojl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
"from V2_TR_part_COLECTIVOjl\n" +
"where substr(clave_organo,0,2)='"+PValidacion.clave_entidad+"' and periodo='"+PValidacion.periodo+"'\n" +
"and id_actor not like '%-%' \n" +
"group by clave_organo,expediente_clave) prin  right join V2_TR_part_COLECTIVOjl sec\n" +
...
"group by sec.clave_organo,sec.expediente_clave,prin.desglose_actores) prin  right join  V2_TR_COLECTIVOjl sec\n" +
"on  prin.clave_organo=sec.clave_organo and  prin.expediente_clave=sec.expediente_clave\n" +
...
"AND PERIODO ='"+PValidacion.periodo+"'\n" +
"GROUP BY CLAVE_ORGANO,EXPEDIENTE_CLAVE,PERIODO)PRIN LEFT JOIN V2_TR_COLECTIVOJL SEC\n" +
