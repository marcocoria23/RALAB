 ...
 */
public class FedV1QPart_act_colectivo {
...
"from(\n" +
"select * from(\n" +
"select * from TR_FED_V1_colectivojl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
"or CANTIDAD_DEMANDADOS>0) where expediente_clave not in (select expediente_clave from TR_FED_V1_part_ACT_colectivojl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
resul=conexion.consultar(sql);
    System.out.println(sql);
      ...
      conexion.close();
            ...
            Logger.getLogger(FedV1QPart_act_colectivo.class.getName()).log(Level.SEVERE, null, ex);
        }
    return Array;    
}
...
"from TR_FED_V1_part_ACT_colectivojl\n" +
"where substr(clave_organo,0,2)='"+PValidacion.clave_entidad+"' and periodo='"+PValidacion.periodo+"'\n" +
"and id_actor not like '%-%' \n" +
"group by clave_organo,expediente_clave) prin  right join TR_FED_V1_part_ACT_colectivojl sec\n" +
...
"group by sec.clave_organo,sec.expediente_clave,prin.desglose_actores) prin  right join  TR_FED_V1_COLECTIVOjl sec\n" +
"on  prin.clave_organo=sec.clave_organo and  prin.expediente_clave=sec.expediente_clave\n" +
...
"AND PERIODO ='"+PValidacion.periodo+"'\n" +
"GROUP BY CLAVE_ORGANO,EXPEDIENTE_CLAVE,PERIODO)PRIN LEFT JOIN TR_FED_V1_COLECTIVOJL SEC\n" +
