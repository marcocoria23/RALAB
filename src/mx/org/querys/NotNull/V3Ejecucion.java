...
public ArrayList Estatus_expedienteNi(String Con1, String Con2){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(ESTATUS_EXPE,'9','No_identificado') ESTATUS_EXPE,REPLACE(COMENTARIOS,',','')COMENTARIOS,PERIODO from "+Con1+"TR_EJECUCION"+Con2+"\n" +
...
public ArrayList FaseConclucion(String Con1, String Con2){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select * from ( \n"+
"select * from(\n"+
"SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,ESTATUS_EXPE,PERIODO FROM "+Con1+"TR_EJECUCION"+Con2+" WHERE \n" +
