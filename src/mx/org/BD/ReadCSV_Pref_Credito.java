...
import Bean_Procedures.Pref_Credito;
 ...
 */
public class ReadCSV_Pref_Credito {
    ...
    public void Read_Pref_Credito() throws FileNotFoundException, IOException {
       ...
       // FileInputStream f = new FileInputStream(Insert.rutaT);
         ...
         try {          
                ...
                if (Insert.CarpetaArchivos==true){
                 ...
                 rutaCarpetaArchivos=Insert.rutaT+"CSV_BD_T.8.1_pref_cred.csv";
            ...
            if (bytesRead >= 3 && bytes[0] == (byte) 0xEF && bytes[1] == (byte) 0xBB && bytes[2] == (byte) 0xBF) {
                System.out.println("Archivo en UTF-8");
                 ...
                 IN_PREF_CREDITO(rutaCarpetaArchivos,Insert.Periodo);
            }else{
                 System.out.println("6.....");
                conUTF8.Convertir_utf8_EBaseDatos(rutaCarpetaArchivos);
                 IN_PREF_CREDITO(conUTF8.rutaNuevoArchivo,Insert.Periodo);
    ...
    public void IN_PREF_CREDITO(String Ruta, String Periodo) throws Exception {
                ...
                try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(rutaArchivoCSV), StandardCharsets.UTF_8));
                    ...
                    if (numeroColumnas == 14) {
                        ...
                        for (CSVRecord record : csvParser) {
                            ...
                            TotalRegistros++;
                            Pref_Credito c = new Pref_Credito();
                            ...
                            c.SetAVISO_ORGANO_JURIS(record.get(4).toUpperCase());
                            c.SetAVISO_AUTORIDAD_ADMIN(record.get(5).toUpperCase());
                            c.SetFECHA_PRESENTACION(record.get(6).toUpperCase());
                            c.SetFECHA_ADMISION(record.get(7).toUpperCase());
                            c.SetPROMOVENTE(record.get(8).toUpperCase());
                            c.SetESPECIFIQUE(record.get(9).toUpperCase());
                            c.SetESTATUS_EXPE(record.get(10).toUpperCase());
                        ...
                        if (TotalRegistros > 0) {
                            ...
                            sd = StructDescriptor.createDescriptor("OBJ_PREF_CREDITO", con);
                            ...
                            descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_PREF_CREDITO", con);
                            System.out.println("entro 4");
                            array_to_pass = new ARRAY(descriptor, con, structs);
                            System.out.println("entro 5");
                            st = con.prepareCall("{? = call(PKG_INTEGRADORCSV.Pref_Credito(?))}");
