...
public class V3_TR_HUELGAJL {
    ...
    public void V3_TR_HUELGAJL(String Cve_Entidad, String Periodo, String Cve_ClaveOrgano) throws Exception {
        ...
        try {
            ...
            ArrayList<ArrayList<String>> fila = QControlExp.V3_TR_HUELGAJL(Cve_Entidad, Periodo, Cve_ClaveOrgano);
            if (fila != null) {
