...
import Bean_Procedures_Federal.BeanColectivoEconomico;
 ...
 */
public class ReadCSV_ColectivoEconomico_Fed {
        ...
        try {
            ...
            try (BufferedReader reader = new BufferedReader(
                ...
                if (numeroColumnas == 33) {
                    ...
                    ArrayList<BeanColectivoEconomico> ad = new ArrayList<>();
                    for (CSVRecord record : csvParser) {
                        if (detectarCharsetFed.esFilaVacia(record, "TMP_FED_COLECTIVO_ECONOMICO")) {
                            continue;
                        }
                        TotalRegistros++;
                    ...
                    if (TotalRegistros > 0) {
                        if (Inserta == true) {
                            ...
                            con = OracleDAOFactoryFED.creaConexion();
                            sd = StructDescriptor.createDescriptor("OBJ_TMP_FED_COLECTIVO_ECONOMICO", con);
                            ...
                            descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_TMP_FED_COLECTIVO_ECONOMICO", con);
                    ...
                    JOptionPane.showMessageDialog(null, "El total de numero de columnas en el archivo T.6.1_colec_nat_eco.csv no coincide con la bd Oracle");
                }
            } catch (IOException e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            null,
                            "Tabla: TMP_FED_COLECTIVO_ECONOMICO\n"
