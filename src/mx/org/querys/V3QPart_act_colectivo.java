...
"from(\n" +
"select * from(\n" +
"select * from V3_tr_colectivojl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
") where expediente_clave not in (select expediente_clave from V3_tr_part_ACT_colectivojl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
"group by clave_organo,expediente_clave) prin  right join V3_tr_part_ACT_colectivojl sec\n" +
...
"group by sec.clave_organo,sec.expediente_clave,prin.desglose_actores) prin  right join  V3_TR_COLECTIVOjl sec\n" +
"on  prin.clave_organo=sec.clave_organo and  prin.expediente_clave=sec.expediente_clave\n" +
...
"AND PERIODO ='"+PValidacion.periodo+"'\n" +
"GROUP BY CLAVE_ORGANO,EXPEDIENTE_CLAVE,PERIODO)PRIN LEFT JOIN V3_TR_COLECTIVOJL SEC\n" +
