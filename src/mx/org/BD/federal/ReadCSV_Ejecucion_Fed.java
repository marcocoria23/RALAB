...
import Bean_Procedures_Federal.BeanEjecucion;
 ...
 */
public class ReadCSV_Ejecucion_Fed {
        ...
        try {
            ...
            try (BufferedReader reader = new BufferedReader(
                ...
                if (numeroColumnas == 12) {
                    ...
                    ArrayList<BeanEjecucion> ad = new ArrayList<>();
                    for (CSVRecord record : csvParser) {
                        if (detectarCharsetFed.esFilaVacia(record, "TMP_FED_EJECUCION")) {
                            continue;
                        }
                        TotalRegistros++;
                    ...
                    if (TotalRegistros > 0) {
                        if (Inserta == true) {
                            ...
                            con = OracleDAOFactoryFED.creaConexion();
                            sd = StructDescriptor.createDescriptor("OBJ_TMP_FED_EJECUCION", con);
                            ...
                            descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_TMP_FED_EJECUCION", con);
                    ...
                    JOptionPane.showMessageDialog(null, "El total de numero de columnas en el archivo T.8.1_ejecu.csv no coincide con la bd Oracle");
                }
            } catch (IOException e) {
