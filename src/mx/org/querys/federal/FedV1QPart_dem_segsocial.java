...
public class FedV1QPart_dem_segsocial {
...
"or CANTIDAD_DEMANDADOS>0) where expediente_clave not in (select expediente_clave from TR_FED_V1_part_DEM_SEG_SOCIALjl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
resul=conexion.consultar(sql);
    System.out.println(sql);
      ...
      conexion.close();
            ...
            Logger.getLogger(FedV1QPart_dem_segsocial.class.getName()).log(Level.SEVERE, null, ex);
        }
    return Array;    
}
...
"FROM TR_FED_V1_part_DEM_SEG_SOCIALjl\n" +
