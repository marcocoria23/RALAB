...
import Bean_Procedures.Part_Act_Colect_Econom;
 ...
 */
public class ReadCSV_Part_Act_Colect_Econom {
    ...
    public void Read_Part_Act_Colect_Econom() throws FileNotFoundException, IOException {
       ...
       try {          
                ...
                if (Insert.CarpetaArchivos==true){
                 ...
                 rutaCarpetaArchivos=Insert.rutaT+"CSV_BD_T.5.2_part_act_colec_nat_eco.csv";
            ...
            if (bytesRead >= 3 && bytes[0] == (byte) 0xEF && bytes[1] == (byte) 0xBB && bytes[2] == (byte) 0xBF) {
                System.out.println("Archivo en UTF-8");
                 ...
                 IN_PART_ACT_COLECT_ECONOM(rutaCarpetaArchivos,Insert.Periodo);
            }else{
                 System.out.println("6.....");
                conUTF8.Convertir_utf8_EBaseDatos(rutaCarpetaArchivos);
                 IN_PART_ACT_COLECT_ECONOM(conUTF8.rutaNuevoArchivo,Insert.Periodo);
    ...
    public void IN_PART_ACT_COLECT_ECONOM(String Ruta, String Periodo) throws Exception {
            ...
            if (bytesRead >= 3 && bytes[0] == (byte) 0xEF && bytes[1] == (byte) 0xBB && bytes[2] == (byte) 0xBF) {
                ...
                try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(rutaArchivoCSV), StandardCharsets.UTF_8));
                    ...
                    if (numeroColumnas == 32) {
                        ...
                        ArrayList<Part_Act_Colect_Econom> ad = new ArrayList<>();
                        for (CSVRecord record : csvParser) {
                            //System.out.println("llenado de csv");
                            TotalRegistros++;
                            Part_Act_Colect_Econom c = new Part_Act_Colect_Econom();
                            ...
                            ad.add(c);
                            if (record.get(4).equals("1") || record.get(4).equals("4") || record.get(4).equals("6")) {
                                JOptionPane.showMessageDialog(null, "Error en el campo ACTOR fuera de catalogo  Clave_organo:" + record.get(1) + " Expediente:" + record.get(2) + " Id_actor:" + record.get(3) + " nota: campo ACTOR solo puede tener opcion 2,3,5,7 Y 99");
                                Inserta = false;
                            }
                        ...
                        if (TotalRegistros > 0) {
                            if (Inserta == true) {
                                ...
                                sd = StructDescriptor.createDescriptor("OBJ_PART_ACT_COLECT_ECONOM", con);
                                ...
                                descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_PART_ACT_COLECT_ECONOM", con);
                                System.out.println("entro 4");
                                array_to_pass = new ARRAY(descriptor, con, structs);
                                System.out.println("entro 5");
                                st = con.prepareCall("{? = call(PKG_INTEGRADORCSV.Part_Act_Colect_Econom(?))}");
    ...
    JOptionPane.showMessageDialog(
        null,
            "Tabla: V3_TMP_PART_ACT_COLECT_ECONOMJL\n" +
