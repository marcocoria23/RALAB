 ...
 */
public class BeanTR_FED_CONTROL_EXPEDIENTE extends Bean implements SQLData {
    ...
    public String getORGANO_JUR_REG() {
        return ORGANO_JUR_REG;
    }

    public void setORGANO_JUR_REG(String ORGANO_JUR_REG) {
        this.ORGANO_JUR_REG = ORGANO_JUR_REG;
    }
    ...
    public void ID_CONTROL(String valor) {
        this.ID_CONTROL = valor;
    }
    ...
    public void ORGANO_JUR_REG(String valor) {
        this.ORGANO_JUR_REG = valor;
    }
