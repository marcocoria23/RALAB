 ...
 */
public class BeanTR_EXP_TERMINACION extends Bean implements SQLData  {
    
    private String SQLTypeName;
    private String ID_TIPO_TERMINACION;
    private String ID_ORGANOJ;
    private String ID_EXPEDIENTE;
    private String PERIODO;
    private String ID_UNIQUE;
        
    public String GetID_TIPO_TERMINACION() {
        return ID_TIPO_TERMINACION;
    }

    public void SetID_TIPO_TERMINACION(String ID_TIPO_TERMINACION) {
        this.ID_TIPO_TERMINACION = ID_TIPO_TERMINACION;
    }
