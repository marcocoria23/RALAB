 ...
 */
public class V2QParaprocesalNE {
...
"        PERIODO \n" +
"        from V2_TR_paraprocesaljl ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO) WHERE SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"'  \n" +
...
public ArrayList Fecha_Admision_SoliNE(){
      ...
      sql="select * from (select ESTATUS_EXPEDIENTE,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(FECHA_ADMISION_SOLI,'DD/MM/YYYY') FECHA_ADMISION_SOLI ,periodo\n" +
          "from V2_TR_paraprocesaljl where periodo = '"+PValidacion.periodo+"'\n" +
