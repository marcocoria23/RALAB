...
"        PERIODO \n" +
"        from "+Con1+"TR_ejecucion"+Con2+" ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO) WHERE SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"'  \n" +
...
"        PERIODO \n" +
"        from "+Con1+"TR_ejecucion"+Con2+" ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO AND EXPE_AÑO NOT IN ('2021','2022','2023','2020','2024','2025')) WHERE SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"'  \n" +
"        or clave_organo='"+PValidacion.clave_organo+"' and periodo = '"+PValidacion.periodo+"') WHERE EXPE_AÑO NOT IN "+PValidacion.AñoJuridico+" ";
  ...
  //Query de validacion donde el año de la fecha de apertura es diferente al año de la clave del expediente.
   public ArrayList Año_Expe_EjecucionNE(String Con1, String Con2){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT * FROM(\n" +
        "SELECT * FROM(\n" +
    ...
    public ArrayList EjecucionFechaAperturaMenor2020(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT \n" +
"    CLAVE_ORGANO,\n" +
...
"TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM "+Con1+"TR_EJECUCION"+Con2+" \n" +
"WHERE \n" +
...
"and  ((substr(clave_organo,0,2)='"+PValidacion.clave_entidad+"'  and periodo='"+PValidacion.periodo+"' ) or  (clave_organo='"+PValidacion.clave_organo+"'  and periodo='"+PValidacion.periodo+"' ))";
 ...
 public ArrayList FECHA_PRESENTACION_FUT(String Con1, String Con2){
      conexion.Conectar();
      Array = new ArrayList();
...
public ArrayList FECHA_CONCLUSION_FUT(String Con1, String Con2){
      conexion.Conectar();
      Array = new ArrayList();
...
"and  ((substr(clave_organo,0,2)='"+PValidacion.clave_entidad+"'  and periodo='"+PValidacion.periodo+"' ) or  (clave_organo='"+PValidacion.clave_organo+"'  and periodo='"+PValidacion.periodo+"' ))";
   ...
   public ArrayList Duplicidad_expediente(String Con1, String Con2){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,TO_CHAR(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY')FECHA_APERTURA_EXPEDIENTE,TO_NUMBER(regexp_replace(expediente_clave, '[^0-9]', ''))expediente_clave2,PERIODO FROM "+Con1+"TR_EJECUCION"+Con2+"\n" +
...
"select CLAVE_ORGANO,expediente_clave,TO_NUMBER(regexp_replace(expediente_clave, '[^0-9]', ''))expediente_clave2,PERIODO from "+Con1+"TR_EJECUCION"+Con2+" \n" +
...
public ArrayList Fecha_ConclusionNE(String Con1, String Con2){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select * from (select ESTATUS_EXPE,clave_organo,expediente_clave,to_char(fecha_apertura_expediente,'DD/MM/YYYY') fecha_apertura_expediente,to_char(fecha_conclusion,'DD/MM/YYYY') fecha_conclusion  ,periodo\n" +
          "from "+Con1+"TR_EJECUCION"+Con2+" where periodo = '"+PValidacion.periodo+"'\n" +
