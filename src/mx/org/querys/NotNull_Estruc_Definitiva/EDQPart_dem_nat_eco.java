 ...
 * @author JOSE.CABRERA
 */
public class EDQPart_dem_nat_eco {
...
resul=conexion.consultar(sql);
    System.out.println(sql);
      ...
      conexion.close();
            ...
            Logger.getLogger(EDQPart_dem_nat_eco.class.getName()).log(Level.SEVERE, null, ex);
        }
    return Array;    
}
...
"        SEC.CLAVE_EXPEDIENTE CLAVE_EXPEDIENTE_COLECTIVO_ECONOM,	\n" +
    ...
    System.out.println(sql);
      try {
          while (resul.next()) {
              Array.add(new String[]{
                  resul.getString("ID_ORGANOJ"),
                  resul.getString("CLAVE_EXPEDIENTE_COLECTIVO_ECONOM"),
                  resul.getString("PREG_INCOMPETENCIA")
                });
          }
      conexion.close();
