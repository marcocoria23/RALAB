...
"FROM TR_EXPEDIENTE\n" +
"WHERE FECHA_APERTURA_EXPED='09/09/1899' AND ID_TIPO_EXPEDIENTE=2\n" +
...
"FROM TR_EXPEDIENTE\n" +
"WHERE FECHA_ULT_ACT_PROC='09/09/1899' AND ID_TIPO_EXPEDIENTE=2\n" +
" and ((SUBSTR(ID_ORGANOJ,0,2)='" + PValidacion.clave_entidad + "' AND PERIODO='" + PValidacion.periodo + "' )OR (ID_ORGANOJ='" + PValidacion.clave_organo + "' AND PERIODO='" + PValidacion.periodo + "'))";
        System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
...
" and  ((substr(ID_ORGANOJ,0,2)='"+PValidacion.clave_entidad+"'  and periodo='"+PValidacion.periodo+"' and ID_TIPO_EXPEDIENTE = 2) \n" +
" or  (ID_ORGANOJ='"+PValidacion.clave_organo+"'  and periodo='"+PValidacion.periodo+"' and ID_TIPO_EXPEDIENTE = 2))";
        System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
            while (resul.next()) {
