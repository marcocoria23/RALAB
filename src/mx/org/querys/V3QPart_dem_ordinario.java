...
"from(\n" +
"select * from(\n" +
"select * from V3_tr_ordinariojl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
" CANTIDAD_DEMANDADOS>0) where expediente_clave not in (select expediente_clave from V3_TR_part_dem_ordinariojl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
"AND PERIODO ='"+PValidacion.periodo+"'\n" +
"GROUP BY CLAVE_ORGANO,EXPEDIENTE_CLAVE,PERIODO)PRIN LEFT JOIN V3_TR_ORDINARIOJL SEC\n" +
