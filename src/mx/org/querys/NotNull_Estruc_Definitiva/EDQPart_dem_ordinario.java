 ...
 * @author JOSE.CABRERA
 */
public class EDQPart_dem_ordinario {
...
resul=conexion.consultar(sql);
    System.out.println(sql);
      ...
      conexion.close();
            ...
            Logger.getLogger(EDQPart_dem_ordinario.class.getName()).log(Level.SEVERE, null, ex);
        }
    return Array;    
}
    ...
    System.out.println(sql);
      try {
          while (resul.next()) {
              Array.add(new String[]{
                  resul.getString("ID_ORGANOJ"),
                  resul.getString("CLAVE_EXPEDIENTE_ORDINARIO"),
                  resul.getString("PREG_INCOMPETENCIA")
                });
          }
      conexion.close();
