 ...
 */
public class V3_TR_PART_DEM_COLECTIVO {

    public void V3_TR_PART_DEM_COLECTIVO(String Cve_Entidad, String Periodo, String Cve_ClaveOrgano) throws Exception {
        ...
        try {
            ...
            ArrayList<BeanV3_TR_PART_DEM_COLECTIVO> ad = new ArrayList<>();
            ArrayList<ArrayList<String>> fila = QControlExp.V3_TR_PART_DEM_COLECTIVOJL(Cve_Entidad, Periodo, Cve_ClaveOrgano);
            if (fila != null) {
                for (int i = 0; i < fila.size(); i++) {
                    BeanV3_TR_PART_DEM_COLECTIVO c = new BeanV3_TR_PART_DEM_COLECTIVO();
                ...
                if (CFilas > 0) {
                    sd = StructDescriptor.createDescriptor("OBJ_V3_TR_PART_DEM_COLECTIVOJL", con);
                    ...
                    descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_V3_TR_PART_DEM_COLECTIVOJL", con);
                    System.out.println("entro 3");
                    array_to_pass = new ARRAY(descriptor, con, structs);
                    System.out.println("entro 4");
                    st = con.prepareCall("{? = call(PKG_INTEGRADORV3.Part_Dem_Colectivo(?))}");
                    ...
                    JOptionPane.showMessageDialog(null, "V3_TR_PART_DEM_COLECTIVOJL sin registros");
                }
            }
        } catch (Exception ex) {
