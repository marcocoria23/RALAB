 ...
 */
public class BeanTR_EXP_CONCEPTO_RECLAM extends Bean implements SQLData {
    
    
    private String SQLTypeName;
    private String ID_CONCEPTO_RECLAM;
    private String ID_ORGANOJ;
    private String ID_EXPEDIENTE;
    private String PERIODO;
    private String ID_UNIQUE;
    
    public String GetID_CONCEPTO_RECLAM() {
        return ID_CONCEPTO_RECLAM;
    }

    public void SetID_CONCEPTO_RECLAM(String ID_CONCEPTO_RECLAM) {
        this.ID_CONCEPTO_RECLAM = ID_CONCEPTO_RECLAM;
    }
