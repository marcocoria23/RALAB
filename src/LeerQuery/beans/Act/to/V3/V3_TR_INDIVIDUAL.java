...
public class V3_TR_INDIVIDUAL {
    ...
    public void V3_TR_INDIVIDUALJL(String Cve_Entidad, String Periodo, String Cve_ClaveOrgano) throws Exception {
        ...
        try {
            ...
            ArrayList<ArrayList<String>> fila = QControlExp.V3_TR_INDIVIDUAL(Cve_Entidad, Periodo, Cve_ClaveOrgano);
            if (fila != null) {
