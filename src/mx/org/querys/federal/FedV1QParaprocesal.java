 ...
 */
public class FedV1QParaprocesal {
...
"        PERIODO \n" +
"        from TR_FED_V1_paraprocesaljl ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO) WHERE SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"'  \n" +
...
"         AND  TO_date('01/08/'||(FECHA_APERTURA_EXPEDIENTES1)||'') ";
      ...
      conexion.close();
            ...
            Logger.getLogger(FedV1QParaprocesal.class.getName()).log(Level.SEVERE, null, ex);
        }
    return Array;
 }
...
public ArrayList Fecha_Admision_SoliNE(){
      ...
      sql="select * from (select ESTATUS_EXPEDIENTE,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(FECHA_ADMISION_SOLI,'DD/MM/YYYY') FECHA_ADMISION_SOLI ,periodo\n" +
          "from TR_FED_V1_paraprocesaljl where periodo = '"+PValidacion.periodo+"'\n" +
