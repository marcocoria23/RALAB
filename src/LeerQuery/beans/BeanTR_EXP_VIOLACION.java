 ...
 */
public class BeanTR_EXP_VIOLACION extends Bean implements SQLData  {
    
        private String SQLTypeName;
        private String ID_TIPO_VIOL_DH;
     ...
     public String GetID_TIPO_VIOL_DH() {
        return ID_TIPO_VIOL_DH;
    }

    public void SetID_TIPO_VIOL_DH(String ID_TIPO_VIOL_DH) {
        this.ID_TIPO_VIOL_DH = ID_TIPO_VIOL_DH;
    }
