...
" and ((SUBSTR(CLAVE_ORGANO,0,2)='" + PValidacion.clave_entidad + "' AND PERIODO='" + PValidacion.periodo + "' )OR (clave_organo='" + PValidacion.clave_organo + "' AND PERIODO='" + PValidacion.periodo + "'))";
    ...
    public ArrayList Año_JudicialCampeche(String Con1, String Con2){
        ...
        sql = "SELECT * FROM (\n"
                ...
                + "        PERIODO \n"
                + "        from "+Con1+"TR_ordinario"+Con2+" ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO) WHERE SUBSTR(CLAVE_ORGANO,0,2)='" + PValidacion.clave_entidad + "' and periodo = '" + PValidacion.periodo + "'  \n"
    ...
    public ArrayList Año_Expe_OrdinarioNE(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT * FROM(\n"
                + "SELECT * FROM(\n"
                ...
                + "PERIODO\n"
                + "from "+Con1+"TR_ordinario"+Con2+" ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO AND EXPE_AÑO NOT IN ('2021','2022','2023','2020','2024','2025')) WHERE SUBSTR(CLAVE_ORGANO,0,2)='" + PValidacion.clave_entidad + "' and periodo = '" + PValidacion.periodo + "' \n"
                + "or clave_organo='" + PValidacion.clave_organo + "' and periodo = '" + PValidacion.periodo + "'";
        //System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
    ...
    public ArrayList FECHA_APERTURA_EXPEDIENTE_FUT(String Con1, String Con2){
        ...
        sql = "SELECT clave_organo, expediente_clave, periodo, TO_CHAR(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY')FECHA_APERTURA_EXPEDIENTE,\n"
                + "TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM  "+Con1+"TR_ORDINARIO"+Con2+"  \n"
                + "WHERE \n"
    ...
    public ArrayList OrdinarioFechaAperturaMenor2020(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT \n" +
"    CLAVE_ORGANO,\n" +
...
"and  ((substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "'  and periodo='" + PValidacion.periodo + "' ) or  (clave_organo='" + PValidacion.clave_organo + "'  and periodo='" + PValidacion.periodo + "' ))";
    ...
    public ArrayList FECHA_DICTO_RESOLUCIONFE_FUT(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
    ...
    public ArrayList FECHA_DICTO_RESOLUCIONAP_FUT(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
    ...
    public ArrayList FECHA_RESOLUCIONAJ_FUT(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
    ...
    public ArrayList Duplicidad_expediente(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,TO_CHAR(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY')FECHA_APERTURA_EXPEDIENTE,TO_NUMBER(regexp_replace(expediente_clave, '[^0-9]', ''))expediente_clave2,PERIODO FROM "+Con1+"TR_ORDINARIO"+Con2+"\n"
                ...
                + "select CLAVE_ORGANO,expediente_clave,TO_NUMBER(regexp_replace(expediente_clave, '[^0-9]', ''))expediente_clave2,PERIODO from "+Con1+"TR_ORDINARIO"+Con2+" \n"
    ...
    public ArrayList Fecha_Acto_ProcesalNE(String Con1, String Con2){
        ...
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(Fecha_Acto_Procesal,'DD/MM/YYYY')Fecha_Acto_Procesal,periodo\n"
                + "from "+Con1+"TR_ordinario"+Con2+" where periodo = '" + PValidacion.periodo + "'\n"
    ...
    public ArrayList Fecha_Dicto_ResolucionFE(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
    ...
    public ArrayList Fecha_Dicto_ResolucionAP(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
    ...
    public ArrayList Fecha_ResolucionAJ(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
   ...
   //ORDINARIO LA FECHA DE AUDIENCIA CELEBRARA NO DEBE SER MENOR A LA FECHA DE APERTURA DEL EXPEDIENTE
    ...
    public ArrayList Fecha_Aud_Presentacion(String Con1, String Con2){
        ...
        sql = "select * from (SELECT S.ENTIDAD_CLAVE,P.CLAVE_ORGANO,P.EXPEDIENTE_CLAVE,to_char(P.FECHA_AUDIEN_CELEBRADA,'DD/MM/YYYY')FECHA_AUDIEN_CELEBRADA,to_char(S.FECHA_PRES_DEMANDA,'DD/MM/YYYY') FECHA_PRES_DEMANDA, P.TIPO_PROCED,P.PERIODO,P.ID_AUDIENCIA\n"
                + "FROM "+Con1+"TR_AUDIENCIAS"+Con2+" P,"+Con1+"TR_ORDINARIO"+Con2+" S\n"
    ...
    public ArrayList Fase_Sol_Escrita(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
    ...
    public ArrayList Fase_Sol_Preliminar(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
    ...
    public ArrayList Fecha_Audi_Prelimi(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
    ...
    public ArrayList Fecha_Dicto_ResolAP(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
    ...
    public ArrayList Fase_Sol_Audi_Juicio(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD,EXPEDIENTE_CLAVE, CLAVE_ORGANO, PERIODO, AUDIENCIA_PRELIM, AUDIENCIA_JUICIO, ESTATUS_EXPEDIENTE, DECODE(FASE_SOLI_EXPEDIENTE,\n"
                + "       1, 'Audiencia preliminar',\n"
    ...
    public ArrayList Fecha_Audiencia_Preliminar(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
    ...
    public ArrayList Fecha_Resol_Audi_Juicio(String Con1, String Con2){
        conexion.Conectar();
        Array = new ArrayList();
