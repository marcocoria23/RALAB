...
import Bean_Procedures.Part_Act_Ordinario;
 ...
 */
public class ReadCSV_Part_Act_Ordinario {
    ...
    public void Read_Part_Act_Ordinario() throws FileNotFoundException, IOException {
       ...
       // FileInputStream f = new FileInputStream(Insert.rutaT);
        ...
        try {          
                ...
                if (Insert.CarpetaArchivos==true){
                 ...
                 rutaCarpetaArchivos=Insert.rutaT+"CSV_BD_T.1.2_part_act_ordinario.csv";
            ...
            if (bytesRead >= 3 && bytes[0] == (byte) 0xEF && bytes[1] == (byte) 0xBB && bytes[2] == (byte) 0xBF) {
                System.out.println("Archivo en UTF-8");
                 ...
                 IN_PART_ACT_ORDINARIO(rutaCarpetaArchivos,Insert.Periodo);
            }else{
                 System.out.println("6.....");
                conUTF8.Convertir_utf8_EBaseDatos(rutaCarpetaArchivos);
                 IN_PART_ACT_ORDINARIO(conUTF8.rutaNuevoArchivo,Insert.Periodo);
    ...
    public void IN_PART_ACT_ORDINARIO(String Ruta, String Periodo) throws Exception {
                ...
                try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(rutaArchivoCSV), StandardCharsets.UTF_8));
                    ...
                    if (numeroColumnas == 26) {
                        ...
                        for (CSVRecord record : csvParser) {
                            ...
                            TotalRegistros++;
                            //.replace("\\n","").trim()
                            Part_Act_Ordinario c = new Part_Act_Ordinario();
                            ...
                            c.SetSEXO(record.get(6).toUpperCase());
                            c.SetEDAD(record.get(7).toUpperCase());
                            c.SetOCUPACION(record.get(8).toUpperCase());
                            c.SetNSS(record.get(9).toUpperCase());
                            c.SetCURP(record.get(10).toUpperCase());
                            c.SetRFC_TRABAJADOR(record.get(11).toUpperCase());
                            c.SetJORNADA(record.get(12).toUpperCase());
                            c.SetNOMBRE_SINDICATO(record.get(13).toUpperCase());
                            c.SetREG_ASOC_SINDICAL(record.get(14).toUpperCase());
                            c.SetTIPO_SINDICATO(record.get(15).toUpperCase());
                            c.SetOTRO_ESP_SINDICATO(record.get(16).toUpperCase());
                            c.SetORG_OBRERA(record.get(17).toUpperCase());
                            c.SetNOMBRE_ORG_OBRERA(record.get(18).toUpperCase());
                            c.SetOTRO_ESP_OBRERA(record.get(19).toUpperCase());
                            c.SetCANT_TRABAJA_INV(record.get(20).toUpperCase());
                            c.SetHOMBRES(record.get(21).toUpperCase());
                            c.SetMUJERES(record.get(22).toUpperCase());
                        ...
                        if (TotalRegistros > 0) {
                            if (Inserta == true) {
                                ...
                                sd = StructDescriptor.createDescriptor("OBJ_PART_ACT_ORDINARIO", con);
                                ...
                                descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_PART_ACT_ORDINARIO", con);
                                System.out.println("entro 4");
                                array_to_pass = new ARRAY(descriptor, con, structs);
                                System.out.println("entro 5");
                                st = con.prepareCall("{? = call(PKG_INTEGRADORCSV.Part_Act_Ordinario(?))}");
