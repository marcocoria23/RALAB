 ...
 */
public class PConPerToV3 extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(PConPerToV3.class.getName());
     ArrayList<String[]> ArrayPeriodo;
    QueryRalabDes queryRalabDes = new QueryRalabDes();
    public static String periodo="";
    /**
     * Creates new form PConPerToV3
     */
    public PConPerToV3() {
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
         if(!PMapeoProcesarActToV3.Cve_Entidad.equals("") ){
        ArrayPeriodo=queryRalabDes.periodo(PMapeoProcesarActToV3.Cve_Entidad,PMapeoProcesarActToV3.Cve_ClaveOrgano);
      ...
      if(!PMapeoProcesarActToV3.Cve_ClaveOrgano.equals("") ){
       ArrayPeriodo=queryRalabDes.periodo(PMapeoProcesarActToV3.Cve_Entidad,PMapeoProcesarActToV3.Cve_ClaveOrgano);
        DefaultTableModel TablaPeriodo = (DefaultTableModel) Tperiodo.getModel();     
        Object[] fila = new Object[ArrayPeriodo.size()];      
        for(int j=0; j<ArrayPeriodo.size(); j++){
      ...
      if (ArrayPeriodo.isEmpty())
      {
          JOptionPane.showMessageDialog(rootPane, "No existe Periodo para la clave_Organo o Clave_entidad seleccionados");
      }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new PConPerToV3().setVisible(true));
    }
