 ...
 */
public class BeanV3_TR_PART_DEM_COLECT_ECONOM extends Bean implements SQLData {
    ...
    private String LATITUD_EMPR;
    private String LONGITUD_EMPR;
    ...
    public String GetLATITUD_EMPR() {
        return LATITUD_EMPR;
    }

    public void SetLATITUD_EMPR(String LATITUD_EMPR) {
        this.LATITUD_EMPR = LATITUD_EMPR;
    }

    public String GetLONGITUD_EMPR() {
        return LONGITUD_EMPR;
    }

    public void SetLONGITUD_EMPR(String LONGITUD_EMPR) {
        this.LONGITUD_EMPR = LONGITUD_EMPR;
    }
