...
"        PERIODO \n" +
"        from TR_FED_V1_ejecucionjl ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO) WHERE SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"'  \n" +
...
"         AND  TO_date('01/08/'||(FECHA_APERTURA_EXPEDIENTES1)||'') ";
      ...
      conexion.close();
            ...
            Logger.getLogger(FedV1QEjecucion.class.getName()).log(Level.SEVERE, null, ex);
        }
    return Array;
 }
...
public ArrayList Fecha_ConclusionNE(){
      ...
      sql="select * from (select ESTATUS_EXPE,clave_organo,expediente_clave,to_char(fecha_apertura_expediente,'DD/MM/YYYY') fecha_apertura_expediente,to_char(fecha_conclusion,'DD/MM/YYYY') fecha_conclusion  ,periodo\n" +
          "from TR_FED_V1_EJECUCIONJL where periodo = '"+PValidacion.periodo+"'\n" +
