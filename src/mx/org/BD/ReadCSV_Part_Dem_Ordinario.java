...
import Bean_Procedures.Part_Dem_Ordinario;
 ...
 */
public class ReadCSV_Part_Dem_Ordinario {
    ...
    public void Read_Part_Dem_Ordinario() throws FileNotFoundException, IOException {
       ...
       // FileInputStream f = new FileInputStream(Insert.rutaT);
        ...
        try {          
                ...
                if (Insert.CarpetaArchivos==true){
                 ...
                 rutaCarpetaArchivos=Insert.rutaT+"CSV_BD_T.1.3_part__dem_ordinario.csv";
            ...
            if (bytesRead >= 3 && bytes[0] == (byte) 0xEF && bytes[1] == (byte) 0xBB && bytes[2] == (byte) 0xBF) {
                System.out.println("Archivo en UTF-8");
                 ...
                 IN_PART_DEM_ORDINARIO(rutaCarpetaArchivos,Insert.Periodo);
            }else{
                 System.out.println("6.....");
                conUTF8.Convertir_utf8_EBaseDatos(rutaCarpetaArchivos);
                 IN_PART_DEM_ORDINARIO(conUTF8.rutaNuevoArchivo,Insert.Periodo);
    ...
    public void IN_PART_DEM_ORDINARIO(String Ruta, String Periodo) throws Exception {
            ...
            if (bytesRead >= 3 && bytes[0] == (byte) 0xEF && bytes[1] == (byte) 0xBB && bytes[2] == (byte) 0xBF) {
                ...
                try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(rutaArchivoCSV), StandardCharsets.UTF_8));
                    ...
                    if (numeroColumnas == 21) {
                        ...
                        ArrayList<Part_Dem_Ordinario> ad = new ArrayList<>();
                        ...
                        if (TotalRegistros > 0) {
                            if (Inserta == true) {
                                ...
                                sd = StructDescriptor.createDescriptor("OBJ_PART_DEM_ORDINARIO", con);
                                ...
                                descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_PART_DEM_ORDINARIO", con);
                                System.out.println("entro 4");
                                array_to_pass = new ARRAY(descriptor, con, structs);
                                System.out.println("entro 5");
                                st = con.prepareCall("{? = call(PKG_INTEGRADORCSV.Part_Dem_Ordinario(?))}");
    ...
    JOptionPane.showMessageDialog(
        null,
            "Tabla: V3_TMP_PART_DEM_ORDINARIOJL\n" +
