 ...
 */
public class BeanTR_EXP_MOTIVO_HUELGA extends Bean implements SQLData  {
    
    private String SQLTypeName;
    private String ID_HUELGA_MOTIVO;
    ...
    public String GetID_HUELGA_MOTIVO() {
        return ID_HUELGA_MOTIVO;
    }

    public void SetID_HUELGA_MOTIVO(String ID_HUELGA_MOTIVO) {
        this.ID_HUELGA_MOTIVO = ID_HUELGA_MOTIVO;
    }
