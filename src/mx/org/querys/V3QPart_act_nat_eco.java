...
") where expediente_clave not in (select expediente_clave from "+Con1+"tr_part_act_COLECT_ECONOM"+Con2+" where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
