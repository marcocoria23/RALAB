 ...
 */
public class EDV3QPart_dem_colectivo {
    ...
    System.out.println(sql);
      try {
          while (resul.next()) {
              Array.add(new String[]{
                  resul.getString("ID_ORGANOJ"),
                  resul.getString("CLAVE_EXPEDIENTE_PART"),
                  resul.getString("PREG_INCOMPETENCIA")
                });
          }
      conexion.close();
...
"        PRIN.ID_ORGANOJ,\n" +
"        PRIN.CLAVE_EXPEDIENTE CLAVE_EXPEDIENTE_PART,\n" +
"        SEC.CLAVE_EXPEDIENTE CLAVE_EXPEDIENTE_COLECTIVO,\n" +
"        DECODE(SEC.ID_ESTATUS_DEMANDA, \n" +
"               '1', 'Admitida', \n" +
"               '2', 'Desechada', \n" +
"               '3', 'Archivo', \n" +
"               '4', 'No se dio trámite al escrito de demanda') AS ID_ESTATUS_DEMANDA \n" +
"    FROM (  \n" +
"        SELECT  \n" +
"            DISTINCT EXP.CLAVE_EXPEDIENTE AS CLAVE_EXPEDIENTE,\n" +
"            EXP.ID_TIPO_EXPEDIENTE,\n" +
"            A.ID_ORGANOJ,\n" +
"            A.PERIODO\n" +
"        FROM TR_DEMANDADO A\n" +
...
try {
          while (resul.next()) {
              Array.add(new String[]{
                  ...
                  resul.getString("CLAVE_EXPEDIENTE"),
                  resul.getString("CANT_DEMANDADOS"),
                  resul.getString("DESGLOSE_DEMANDADOS")
                });
          }
      conexion.close();
     } catch (SQLException ex) {
