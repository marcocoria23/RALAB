    ...
    public void V3_TR_PART_DEM_INDIVIDUALJL() throws Exception {
        ...
        try {
            ...
            if (fila != null) {
                ...
                if (CFilas > 0) {
                    sd = StructDescriptor.createDescriptor("OBJ_V3_TR_PART_DEM_INDIVIDUALJL", con);
                    ...
                    descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_V3_TR_PART_DEM_INDIVIDUALJL", con);
                    System.out.println("entro 3");
                    array_to_pass = new ARRAY(descriptor, con, structs);
                    System.out.println("entro 4");
                    st = con.prepareCall("{? = call(PKG_INTEGRADORV3.Part_Dem_Individual(?))}");
                    ...
                    JOptionPane.showMessageDialog(null, "V3_TR_PART_DEM_INDIVIDUAL sin registros");
                }
            }
        } catch (Exception ex) {
