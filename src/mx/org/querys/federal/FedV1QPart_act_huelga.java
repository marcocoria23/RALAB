...
public class FedV1QPart_act_huelga {
...
"from(\n" +
"select * from(\n" +
"select * from TR_FED_V1_huelgajl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
"or CANTIDAD_DEMANDADOS>0) where expediente_clave not in (select expediente_clave from TR_FED_V1_part_act_HUELGAjl where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
resul=conexion.consultar(sql);
    System.out.println(sql);
      ...
      conexion.close();
            ...
            Logger.getLogger(FedV1QPart_act_huelga.class.getName()).log(Level.SEVERE, null, ex);
        }
    return Array;    
}
...
"FROM TR_FED_V1_part_act_HUELGAjl\n" +
...
"AND PERIODO ='"+PValidacion.periodo+"'\n" +
"GROUP BY CLAVE_ORGANO,EXPEDIENTE_CLAVE,PERIODO)PRIN LEFT JOIN TR_FED_V1_HUELGAJL SEC\n" +
