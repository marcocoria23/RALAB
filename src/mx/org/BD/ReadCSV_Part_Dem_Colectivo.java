...
public class ReadCSV_Part_Dem_Colectivo {
    ...
    public void Read_Part_Dem_colectivo() throws FileNotFoundException, IOException {
         ...
         try {          
            ...
            if (bytesRead >= 3 && bytes[0] == (byte) 0xEF && bytes[1] == (byte) 0xBB && bytes[2] == (byte) 0xBF) {
                System.out.println("Archivo en UTF-8");
                 ...
                 IN_PART_DEM_COLECTIVO(rutaCarpetaArchivos,Insert.Periodo);
            }else{
                 System.out.println("6.....");
                conUTF8.Convertir_utf8_EBaseDatos(rutaCarpetaArchivos);
                 IN_PART_DEM_COLECTIVO(conUTF8.rutaNuevoArchivo,Insert.Periodo);
    ...
    public void IN_PART_DEM_COLECTIVO(String Ruta, String Periodo) throws Exception {
                    ...
                    if (numeroColumnas == 32) {
                       // System.out.println("+hellooou+" + numeroColumnas);
                        ...
                        for (CSVRecord record : csvParser) {
                            ...
                            ad.add(c);
                            if (record.get(4).equals("4")) {
                                JOptionPane.showMessageDialog(null, "Error en el campo DEMANDADO fuera de catalogo  Clave_organo:" + record.get(1) + " Expediente:" + record.get(2) + "Id_demandado:" + record.get(3) + "  nota: campo DEMANDADO solo puede tener opcion 1,2,3,5 Y 9");
                                Inserta = false;
                            }
                        }
                        ...
                        if (TotalRegistros > 0) {
                            if (Inserta == true) {
                                ...
                                sd = StructDescriptor.createDescriptor("OBJ_PART_DEM_COLECTIVO", con);
                                ...
                                descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_PART_DEM_COLECTIVO", con);
                                System.out.println("entro 4");
                                array_to_pass = new ARRAY(descriptor, con, structs);
                                System.out.println("entro 5");
                                st = con.prepareCall("{? = call(PKG_INTEGRADORCSV.Part_Dem_Colectivo(?))}");
    ...
    JOptionPane.showMessageDialog(
        null,
             "Tabla: V3_TMP_PART_DEM_COLECTIVOJL\n" +
