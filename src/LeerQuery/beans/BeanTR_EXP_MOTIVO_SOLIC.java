 ...
 */
public class BeanTR_EXP_MOTIVO_SOLIC extends Bean implements SQLData  {
    
        private String SQLTypeName;
        private String ID_MOTIVO_SOL_PROMO;
        private String ID_ORGANOJ;
        private String ID_EXPEDIENTE;
        private String PERIODO;
        private String ID_UNIQUE;
        
      public String GetID_MOTIVO_SOL_PROMO() {
        return ID_MOTIVO_SOL_PROMO;
      }

       public void SetID_MOTIVO_SOL_PROMO(String ID_MOTIVO_SOL_PROMO) {
        this.ID_MOTIVO_SOL_PROMO = ID_MOTIVO_SOL_PROMO;
    }
