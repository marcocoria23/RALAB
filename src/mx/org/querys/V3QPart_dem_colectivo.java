...
" CANTIDAD_DEMANDADOS>0) where expediente_clave not in (select expediente_clave from "+Con1+"tr_part_DEM_colectivo"+Con2+" where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
public ArrayList Dif_demandadosNE(String Con1, String Con2){
    conexion.Conectar();
    Array = new ArrayList();
    sql="SELECT * FROM(\n" +
