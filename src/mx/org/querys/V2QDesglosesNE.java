...
public ArrayList Desglose_OrdinarioNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select prin.clave_organo clave_organo,Ordinario,count(sec.expediente_clave) Total_expe from V2_TR_control_expedientejl PRIN \n" +
      "left join V2_TR_ordinariojl sec\n" +
...
public ArrayList Desglose_IndividualNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select prin.clave_organo clave_organo,ESPECIAL_INDIVI,count(sec.expediente_clave) Total_expe from V2_TR_control_expedientejl PRIN \n" +
      "left join V2_TR_individualjl sec\n" +
      "on  Prin.clave_organo=sec.clave_organo and prin.periodo=sec.periodo\n" +
      "where substr(prin.clave_organo,0,2)='"+PValidacion.clave_entidad+"' and prin.periodo='"+PValidacion.periodo+"'  or prin.clave_organo='"+PValidacion.clave_organo+"'   and prin.periodo='"+PValidacion.periodo+"' \n" +
...
public ArrayList Desglose_ColectivoNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select prin.clave_organo clave_organo,ESPECIAL_COLECT,count(sec.expediente_clave) Total_expe from V2_TR_control_expedientejl PRIN \n" +
      "left join V2_TR_colectivojl sec\n" +
      "on  Prin.clave_organo=sec.clave_organo and prin.periodo=sec.periodo\n" +
      "where substr(prin.clave_organo,0,2)='"+PValidacion.clave_entidad+"' and prin.periodo='"+PValidacion.periodo+"'  or prin.clave_organo='"+PValidacion.clave_organo+"'   and prin.periodo='"+PValidacion.periodo+"' \n" +
...
public ArrayList Desglose_HuelgaNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select prin.clave_organo clave_organo,HUELGA,count(sec.expediente_clave) Total_expe from V2_TR_control_expedientejl PRIN \n" +
      "left join V2_TR_huelgajl sec\n" +
      "on  Prin.clave_organo=sec.clave_organo and prin.periodo=sec.periodo\n" +
      "where substr(prin.clave_organo,0,2)='"+PValidacion.clave_entidad+"' and prin.periodo='"+PValidacion.periodo+"'  or prin.clave_organo='"+PValidacion.clave_organo+"'   and prin.periodo='"+PValidacion.periodo+"' \n" +
...
public ArrayList Desglose_SsocialNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select prin.clave_organo clave_organo,SEGURIDAD_SOCIAL,count(sec.expediente_clave) Total_expe from V2_TR_control_expedientejl PRIN \n" +
      "left join V2_TR_seg_socialjl sec\n" +
      "on  Prin.clave_organo=sec.clave_organo and prin.periodo=sec.periodo\n" +
      "where substr(prin.clave_organo,0,2)='"+PValidacion.clave_entidad+"' and prin.periodo='"+PValidacion.periodo+"'  or prin.clave_organo='"+PValidacion.clave_organo+"'   and prin.periodo='"+PValidacion.periodo+"' \n" +
      "group by prin.clave_organo,SEGURIDAD_SOCIAL ORDER BY clave_organo";
      //System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
          while (resul.next()) {
              Array.add(new String[]{
                  resul.getString("clave_organo"),
                  resul.getString("SEGURIDAD_SOCIAL"),
                  resul.getString("Total_expe")
                });
          }
      conexion.close();
...
// Diferencia entre el total de expedientes colectivo economico vs el desglose de expedientes en procedimiento Colectivo Economico.
  public ArrayList Desglose_Colec_EconomNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select prin.clave_organo clave_organo,COL_NATU_ECONOMICA,count(sec.expediente_clave) Total_expe from V2_TR_control_expedientejl PRIN \n" +
      "left join V2_TR_colect_economjl sec\n" +
      "on  Prin.clave_organo=sec.clave_organo and prin.periodo=sec.periodo\n" +
      "where substr(prin.clave_organo,0,2)='"+PValidacion.clave_entidad+"' and prin.periodo='"+PValidacion.periodo+"'  or prin.clave_organo='"+PValidacion.clave_organo+"'   and prin.periodo='"+PValidacion.periodo+"' \n" +
  ...
  // Diferencia entre el total de expedientes Paraprocesal vs el desglose de expedientes en procedimiento Paraprocesal.
  public ArrayList Desglose_ParaprocesalNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select prin.clave_organo clave_organo,PARAP_VOLUNTARIO,count(sec.expediente_clave) Total_expe from V2_TR_control_expedientejl PRIN \n" +
      "left join V2_TR_paraprocesaljl sec\n" +
      "on  Prin.clave_organo=sec.clave_organo and prin.periodo=sec.periodo\n" +
      "where substr(prin.clave_organo,0,2)='"+PValidacion.clave_entidad+"' and prin.periodo='"+PValidacion.periodo+"'  or prin.clave_organo='"+PValidacion.clave_organo+"'   and prin.periodo='"+PValidacion.periodo+"' \n" +
  ...
  public ArrayList Desglose_TerceriasNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select prin.clave_organo clave_organo,TERCERIAS,count(sec.expediente_clave) Total_expe from V2_TR_control_expedientejl PRIN \n" +
      "left join V2_TR_terceriasjl sec\n" +
      "on  Prin.clave_organo=sec.clave_organo and prin.periodo=sec.periodo\n" +
      "where substr(prin.clave_organo,0,2)='"+PValidacion.clave_entidad+"' and prin.periodo='"+PValidacion.periodo+"'  or prin.clave_organo='"+PValidacion.clave_organo+"'   and prin.periodo='"+PValidacion.periodo+"' \n" +
  ...
  // Diferencia entre el total de expedientes Preferencia de credito vs el desglose de expedientes en procedimiento Preferencia de credito.
  public ArrayList Desglose_Pref_CreditoNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select prin.clave_organo clave_organo,PREF_CREDITO,count(sec.expediente_clave) Total_expe from V2_TR_control_expedientejl PRIN \n" +
      "left join V2_TR_pref_creditojl sec\n" +
      "on  Prin.clave_organo=sec.clave_organo and prin.periodo=sec.periodo\n" +
      "where substr(prin.clave_organo,0,2)='"+PValidacion.clave_entidad+"' and prin.periodo='"+PValidacion.periodo+"'  or prin.clave_organo='"+PValidacion.clave_organo+"'   and prin.periodo='"+PValidacion.periodo+"' \n" +
  ...
  public ArrayList Desglose_EjecucionNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select prin.clave_organo clave_organo,EJECUCION,count(sec.expediente_clave) Total_expe from V2_TR_control_expedientejl PRIN \n" +
      "left join V2_TR_ejecucionjl sec\n" +
      "on  Prin.clave_organo=sec.clave_organo and prin.periodo=sec.periodo\n" +
      "where substr(prin.clave_organo,0,2)='"+PValidacion.clave_entidad+"' and prin.periodo='"+PValidacion.periodo+"'  or prin.clave_organo='"+PValidacion.clave_organo+"'   and prin.periodo='"+PValidacion.periodo+"' \n" +
