...
public class ReadCSV_Part_Dem_Huelga {
    ...
    public void Read_Part_Dem_Huelga() throws FileNotFoundException, IOException {
         ...
         try {          
            ...
            if (bytesRead >= 3 && bytes[0] == (byte) 0xEF && bytes[1] == (byte) 0xBB && bytes[2] == (byte) 0xBF) {
                System.out.println("Archivo en UTF-8");
                 ...
                 IN_PART_DEM_HUELGA(rutaCarpetaArchivos,Insert.Periodo);
            }else{
                 System.out.println("6.....");
                conUTF8.Convertir_utf8_EBaseDatos(rutaCarpetaArchivos);
                 IN_PART_DEM_HUELGA(conUTF8.rutaNuevoArchivo,Insert.Periodo);
    ...
    public void IN_PART_DEM_HUELGA(String Ruta, String Periodo) throws Exception {
                    ...
                    if (numeroColumnas == 21) {
                        ...
                        for (CSVRecord record : csvParser) {
                            ...
                            if (record.get(4).equals("2") || record.get(4).equals("3") || record.get(4).equals("4") || record.get(4).equals("5")) {
                                JOptionPane.showMessageDialog(null, "Error en el campo DEMANDADO fuera de catalogo  Clave_organo:" + record.get(1) + " Expediente:" + record.get(2) + " id_demandado:" + record.get(3) + " nota: campo DEMANDADO solo puede tener opcion 1 Y 9");
                                Inserta = false;
                            }
                        }
                        ...
                        if (TotalRegistros > 0) {
                            if (Inserta == true) {
                                ...
                                sd = StructDescriptor.createDescriptor("OBJ_PART_DEM_HUELGA", con);
                                ...
                                descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_PART_DEM_HUELGA", con);
                                System.out.println("entro 4");
                                array_to_pass = new ARRAY(descriptor, con, structs);
                                System.out.println("entro 5");
                                st = con.prepareCall("{? = call(PKG_INTEGRADORCSV.Part_Dem_Huelga(?))}");
    ...
    JOptionPane.showMessageDialog(
        null,
            "Tabla: V3_TMP_PART_DEM_HUELGAJL\n" +
